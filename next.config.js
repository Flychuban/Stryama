    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://*.clerk.accounts.dev https://*.stryama.app https://challenges.cloudflare.com https://*.e2b.dev https://*.e2b.app https://js.stripe.com https://*.js.stripe.com https://maps.googleapis.com",
              "style-src 'self' 'unsafe-inline' https://*.e2b.dev https://*.e2b.app",
              "img-src 'self' data: blob: https: https://img.clerk.com https://*.stryama.app https://*.stripe.com",
              "font-src 'self' data:",
